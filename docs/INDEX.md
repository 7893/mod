...
8. [THIRD_PARTY_NOTICES.md](../THIRD_PARTY_NOTICES.md)：第三方组件声明、中国地图数据隔离策略与使用边界。
9. [HISTORY-CATALOG.md](HISTORY-CATALOG.md)：冻结历史的稳定编号、可见性、哈希与备份状态目录。

### 本轮重大缺陷

- [KI-103 安全脱敏不彻底与生产资产信息残留](issues/KI-103-安全脱敏不彻底与生产资产信息残留.md)
- [KI-107 HeatWave 原生 SHAP 权限边界与预生成缺口](issues/KI-107-HeatWave原生SHAP权限边界与预生成缺口.md)
- [KI-104 开源社区治理体系缺位与协作机制断档](issues/KI-104-开源社区治理体系缺位与协作机制断档.md)
- [KI-105 外部开发可移植性缺口与私有 Harness 工具耦合](issues/KI-105-外部开发可移植性缺口与私有Harness工具耦合.md)
- [KI-102 六屏信息去重与全量可见布局重构](issues/KI-102-六屏信息去重与全量可见布局重构.md)
- [KI-100 大屏图表物料抽象与业务视图配置解耦](issues/KI-100-大屏图表物料抽象与业务视图配置解耦.md)
- [KI-099 图表 Design Tokens 双端契约与静态门禁治理](issues/KI-099-图表DesignTokens双端契约与静态门禁治理.md)
...
- 停用的自研协作状态机（调度器、agent 定义、任务与交接记录）已于 2026-09-17 经授权删除；
  相关演进事实保留在 Git 与冻结历史文档中，不恢复、不运行、不维护。
...
[2026-09-17 约束与文档收敛前现状切片](history/2026-09-17-CONSTRAINT-DOCUMENT-CONVERGENCE-SNAPSHOT.md)，以及
[2026-09-21 前端重构部署收口前现状切片](history/2026-09-21-FRONTEND-REFACTOR-PRE-DOCUMENT-CONVERGENCE.md)。
