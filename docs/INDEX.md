...
- [01-产品与业务设计-待确认.md](history/01-产品与业务设计-待确认.md)
- [02-数据模型-待确认.md](history/02-数据模型-待确认.md)
- [03-技术架构与实施计划.md](history/03-技术架构与实施计划.md)
- [08-模拟数据V2生成与验收规范-待最终确认.md](history/08-模拟数据V2生成与验收规范-待最终确认.md)

## V1 与组件路线历史

- [04-阶段1精确变更清单-待批准.md](history/04-阶段1精确变更清单-待批准.md)
- [05-USA数据库执行清单-待批准.md](history/05-USA数据库执行清单-待批准.md)
- [06-组件化实施基线.md](history/06-组件化实施基线.md)
- [07-当前部署与运维基线.md](history/07-当前部署与运维基线.md)
...
- [09-V2模拟数据生成实施任务书.md](history/09-V2模拟数据生成实施任务书.md)
- [10-V2模拟数据第一轮审阅报告.md](history/10-V2模拟数据第一轮审阅报告.md)
- [11-V2模拟数据第二轮执行与整改报告.md](history/11-V2模拟数据第二轮执行与整改报告.md)
- [12-V2模拟数据第三轮执行与整改报告.md](history/12-V2模拟数据第三轮执行与整改报告.md)
- [13-V2模拟数据第四轮执行与整改报告.md](history/13-V2模拟数据第四轮执行与整改报告.md)
- [14-V2模拟数据第五轮执行与整改报告.md](history/14-V2模拟数据第五轮执行与整改报告.md)
- [15-V2模拟数据第六轮执行与整改报告.md](history/15-V2模拟数据第六轮执行与整改报告.md)
- [16-V2模拟数据指标口径修正与基准最终冻结声明.md](history/16-V2模拟数据指标口径修正与基准最终冻结声明.md)

## V2 数据库导入与验收

- [17-V2独立数据库导入方案与前置检查清单.md](history/17-V2独立数据库导入方案与前置检查清单.md)
- [18-V2数据库导入前只读环境核查报告.md](history/18-V2数据库导入前只读环境核查报告.md)
- [19-V2数据库导入执行与验收报告.md](history/19-V2数据库导入执行与验收报告.md)
- [20-V2数据库独立复审与账号整改报告.md](history/20-V2数据库独立复审与账号整改报告.md)
- [21-V2数据与项目目录现状基线.md](history/21-V2数据与项目目录现状基线.md)
- [22-项目目录集中整理记录.md](history/22-项目目录集中整理记录.md)
...
- [archive/legacy-collaboration/](../archive/legacy-collaboration/)：已归档的停用协作状态机（调度器、agent 定义、任务与交接记录）；
  只读历史，不恢复、不运行、不维护。
