...
class TimePatternSystem:
    ...
    # 小时系数（北京时间）——核心工作时间 8:30-11:30 与 13:30-17:00
    # 早到/加班/夜间存在但非普遍（低权重），体现真实但不规律
    HOUR_FACTORS = {
        0: 0.015, 1: 0.008, 2: 0.006, 3: 0.005, 4: 0.005, 5: 0.01,
        6: 0.04, 7: 0.12,              # 少量早到
        8: 0.70,                       # 8:30 起进入工作(整点权重体现半点后爬升)
        9: 1.15, 10: 1.25, 11: 1.05,   # 上午核心 8:30-11:30
        12: 0.20,                      # 午休(12:00-13:30)明显回落
        13: 0.55,                      # 13:30 起恢复
        14: 1.20, 15: 1.25, 16: 1.10,  # 下午核心 13:30-17:00
        17: 0.45,                      # 17:00 后收尾
        18: 0.18, 19: 0.10, 20: 0.07, 21: 0.04, 22: 0.025, 23: 0.015,
    }
